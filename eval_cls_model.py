...
def main():
    ...
    parser.add_argument("--path", type=str, default="/group/modelzoo/test_dataset/imagenet_torchvision/val")
    ...
    model = create_cls_model(args.model, False)
    checkpoint = torch.load(args.weight_url)
    checkpoint = checkpoint['state_dict']#[args.ema]
